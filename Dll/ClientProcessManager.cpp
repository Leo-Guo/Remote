...
CClientProcessManager::CClientProcessManager(CIOCPClient* ClientObject):CManager(ClientObject)
{
...
void CClientProcessManager::PacketHandleIO(PBYTE BufferData, ULONG_PTR BufferLength)
{
	switch (BufferData[0])
	{
